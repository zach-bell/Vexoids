...
public class MenuScreen extends Screen{
	...
	String difficulty,options="Options nigga";
...
//	Difficulty Switch
		if(cheatActive){
//			Difficulty Switch
			if (((Gdx.input.isKeyPressed(Keys.RIGHT) || toughNoodles==2) && Switch2 != 1 && Toggle2 == 3) ||
					((Gdx.input.isKeyPressed(Keys.LEFT) || toughNoodles==1) && Switch2 != 1 && Toggle2 == 4)){
				difficulty = "vexoid";
				difficultyImage = TextureManager.DIFFICULTY_VEXOID;
				SoundManager.sound1.play(1);
				if(Gdx.input.isKeyPressed(Keys.LEFT)|| toughNoodles==1)
					Toggle2 = 2;
				else
					Toggle2 = 2;
			} else
			if (((Gdx.input.isKeyPressed(Keys.RIGHT)||toughNoodles==2) && Switch2 != 1 && Toggle2 == 1) ||
					((Gdx.input.isKeyPressed(Keys.LEFT)||toughNoodles==1) && Switch2 != 1 && Toggle2 == 2)){
				difficulty = "hard";
			...
			if (((Gdx.input.isKeyPressed(Keys.RIGHT)||toughNoodles==2) && Switch2 != 1 && Toggle2 == 2) ||
					((Gdx.input.isKeyPressed(Keys.LEFT)||toughNoodles==1) && Switch2 != 1 && Toggle2 == 1)){
				difficulty = "easy";
			...
			if (((Gdx.input.isKeyPressed(Keys.RIGHT)||toughNoodles==2) && Switch2 != 1 && Toggle2 == 4) ||
					((Gdx.input.isKeyPressed(Keys.LEFT)||toughNoodles==1) && Switch2 != 1 && Toggle2 == 3)){
				difficulty = "medium";
			...
			if (Gdx.input.isKeyPressed(Keys.RIGHT) || Gdx.input.isKeyPressed(Keys.LEFT)||toughNoodles==1||toughNoodles==2)
				Switch2 = 1;
			else
				Switch2 = 0;
